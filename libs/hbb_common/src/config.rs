...
pub const LINK_DOCS_HOME: &str = "https://www.pcnet-it.com.br/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://www.pcnet-it.com.br/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.114.41"];
